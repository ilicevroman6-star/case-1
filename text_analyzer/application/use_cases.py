...
from domain.types import AnalysisResult, Language, Polarity, TextStats
...
from infrastructure.syllable_counters import get_syllable_counter, split_sentences, split_words
